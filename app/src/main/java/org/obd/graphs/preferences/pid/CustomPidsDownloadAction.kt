...
class CustomPidsDownloadAction(
    context: Context,
    attrs: AttributeSet?
    ...
    init {
        setOnPreferenceClickListener {
            ...
            val title = context.getString(R.string.pref_pid_custom_download_confirmation_dialog)
            ...
            builder
                ...
                .setPositiveButton(yes) { _, _ ->
                    sendBroadcastEvent(CUSTOM_PIDS_DOWNLOAD)
