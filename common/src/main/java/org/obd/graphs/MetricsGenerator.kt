...
class MetricsGenerator (private val debugBuild:Boolean): MetricsProcessor {
    ...
    private data class MetricGeneratorDescription (val pid: PidDefinition, val data: MutableList<Int>, var counter: Int=0)
    private val generatorEntries = mutableListOf(
        MetricGeneratorDescription(
            pid = PidDefinition(DYNAMIC_SELECTOR_PID_ID,1,"A","22","18F0","","",-1,10, ValueType.INT),
            data = mutableListOf(2,2,2,2,0,0,0,0,0,4,4,4,4,4,4,2,2,2,2,0,0,0,0,0,4,4,4,4,4,4,2,2,2,2,0,0,0,0,0,4,4,4,4,4,4)
        ),
    ...
    private fun isBroadcastingFakeMetricsEnabled(): Boolean = debugBuild &&
