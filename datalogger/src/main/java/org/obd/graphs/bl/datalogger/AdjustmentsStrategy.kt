...
class AdjustmentsStrategy {
    ...
    fun getAdjustments(strategy: QueryStrategyType, preferences: DataLoggerPreferences = dataLoggerPreferences.instance) : Adjustments =
        when (strategy) {
    ...
    private fun getDefaultAdjustments(preferences: DataLoggerPreferences) = Adjustments.builder()
        .debugEnabled(preferences.debugLogging)
