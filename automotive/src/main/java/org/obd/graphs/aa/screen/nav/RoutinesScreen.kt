...
import org.obd.graphs.bl.datalogger.ROUTINE_EXECUTED_SUCCESSFULLY_EVENT
import org.obd.graphs.bl.datalogger.ROUTINE_EXECUTION_FAILED_EVENT
import org.obd.graphs.bl.datalogger.ROUTINE_EXECUTION_NO_DATA_RECEIVED_EVENT
import org.obd.graphs.bl.datalogger.ROUTINE_REJECTED_EVENT
import org.obd.graphs.bl.datalogger.ROUTINE_UNKNOWN_STATUS_EVENT
import org.obd.graphs.bl.datalogger.ROUTINE_WORKFLOW_NOT_RUNNING_EVENT
...
internal class RoutinesScreen(
    ...
    private fun buildItem(data: PidDefinition): Row {
        ...
        if (data.id == routineId) {
            rowBuilder =
                if (routineExecutionSuccessfully) {
                    rowBuilder.setImage(
                        CarIcon
                            .Builder(
